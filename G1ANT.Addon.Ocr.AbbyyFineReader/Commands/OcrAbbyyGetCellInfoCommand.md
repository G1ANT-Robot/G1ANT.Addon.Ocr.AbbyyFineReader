...
This command retrieves information about a table cell and returns its coordinates in [point](https://manual.g1ant.com/link/G1ANT.Language/G1ANT.Language/Structures/PointStructure.md) format.
